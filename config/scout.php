...
return [
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Here you may configure your TNTSearch settings. TNTSearch is a free driver
    | providing full text search support to your models.
    |
    */
    'tntsearch' => [
        ...
        'fuzzy' => [
            ...
            // The number of one character changes that need to be made to one
